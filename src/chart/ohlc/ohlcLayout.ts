...
export interface OHLCItemLayout {
    sign: number
    initBaseline: number
    ends: number[][]
    brushRect: RectLike
...
export interface OHLCLayoutMeta {
    candleWidth: number
    isSimpleBox: boolean
}

const ohlcLayout: StageHandler = {

    seriesType: 'ohlc',

    plan: createRenderPlanner(),

    reset: function (seriesModel: OHLCSeriesModel) {
...
function calculateCandleWidth(seriesModel: OHLCSeriesModel, data: SeriesData) {
